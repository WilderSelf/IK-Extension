 ...
 *
 * No angle constraints (v1). Returns a NEW array; inputs are not mutated.
 *
 * If the target is farther than the chain can reach, the chain straightens
 * directly toward the target from the root.
 */
